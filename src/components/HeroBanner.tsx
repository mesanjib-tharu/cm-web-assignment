  ...
  return (
    ...
    >
      <div className="w-full pt-8">
        <div className="flex flex-col lg:flex-row justify-between bg-white bg-opacity-30 rounded-tl-2xl rounded-tr-2xl relative">
          <div className="flex flex-col items-start w-full lg:w-[50%] p-6 lg:p-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-6">
              <Button
                className="btn btn-md text-nowrap btn-primary font-semibold"
                label="Start Learning Now"
              />
              <Button
                className="btn btn-md text-nowrap btn-outline font-semibold"
                label="Talk to the Advisor"
              />
            </div>
          </div>

          <div className="w-full lg:w-[50%] h-auto lg:h-[650px] hidden sm:block">
            <Image
              src={bannerImage}
              alt="Hero Banner"
        ...
        <div className="absolute top-[40px] left-6 sm:left-10">
